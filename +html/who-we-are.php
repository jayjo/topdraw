...
<section class="internal_hero">
	<img src="assets/images/eric_bachofner_ram.png" alt="" class="inside_hero"/>
	<div class="content">
		<div class="wrapper">
	...
	<div class="wrapper">
		...
		<div class="col layout cf">
			...
			<div class="two_col right cf">
				<img src="assets/images/eric_bachofner_elk.png" alt="" class="col_image"/>
			</div>
		</div>
		<div class="col layout cf">
			<div class="two_col left cf">
				<img src="assets/images/eric_bachofner_goat.png" alt="" class="col_image"/>
			</div>
			<div class="two_col right cf">
