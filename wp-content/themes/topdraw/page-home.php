...
<section class="second">
	<div class="group top cf">
		<div class="image_container top">
			<img src="<?php bloginfo('template_directory'); ?>/img/elk.png" alt="" />
		</div>
	...
	<div class="group bottom cf">
		<div class="image_container bottom">
			<img src="<?php bloginfo('template_directory'); ?>/img/map.png" alt="" />
		</div>
		<div class="content two cf">
			<div class="wrapper">
				<div class="info right">
					<h1>State by State</h1>
					<p>Have a look at Colorado and our in-depth unit-analysis and trophy-analysis breakdown. We'll be adding more states as soon as we're sure we're providing you with guaranteed results.</p>
					<a href="colorado.php" class="button red solid large">View Colorado<span class="arrow"><?php include 'inc/arrow.php'; ?></span></a>
				</div>
			</div>
		</div>
	</div>
	<div class="bullseye">
		<img src="<?php bloginfo('template_directory'); ?>/img/icon_bullseye.png" alt= "" />
	</div>
</section>
