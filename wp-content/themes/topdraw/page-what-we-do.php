...
<section class="internal-hero" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/adams-sneak.png)" alt="">
	<div class="content">
		<div class="wrapper">
...
<section class="internal_content">
	<div class="wrapper cf">
		<h1>Trophies don't have to be bought</h1>
		...
		<div class="col layout cf">
			...
			<div class="two_col left">
				<img src="<?php bloginfo('template_directory'); ?>/assets/img/big-elk.png" alt="" />
			</div>
		...
		<p class="centery"><a href="<?php echo get_permalink(1518); ?>" class="button large solid red">Check out our resources</a></p>
	<div class="wrapper cf">
		<div class="col layout cf">
			<div class="two_col left cf">
			...
			<div class="two_col right cf">
				<img src="<?php bloginfo('template_directory'); ?>/assets/img/big-elk2.png" alt="" />
			</div>
		</div>
		<div class="col layout cf">
			<div class="single_col">
