...
<section class="internal-hero" style="background-image: url(<?php bloginfo('template_directory'); ?>/assets/img/eric_bachofner_ram.png)" alt="">
	<div class="content">
		<div class="wrapper">
	...
	<div class="wrapper">
		...
		<div class="col layout cf">
			<div class="two_col left cf">
				<p>Welcome to Top Draw. I’d like to introduce myself to those that don’t know me.  My name is  Eric Bachofner and I founded Top Draw Consulting to help DIY bow hunters like yourself apply for and draw the best hunts available in the Rocky Mountain states. </p>
